...
//
//@date     april 2021
//@brief    àíèìàöèÿ, ïî÷òè ìóëüòèê, "Êîëîíèçàöèÿ".
//          ïîñâÿùåíèå 60 ëåòèş ïîëåòà ÷åëîâåêà â êîñìîñ.
//
...
void StartTitles ()
    ...
    while (x <= 300)
        ...
        txTextOut (x + 20, 100, "ÁÎ×ÊÀĞÅÂ ÔÈËÜÌ");
        x = x + 1;
        txSleep (10);
        }
    ...
    while (x <= 250)
        ...
        txSetColor (TX_BLACK, 10);
        txSelectFont ("Tahoma", 40);
        txTextOut (300, 100, "ÁÎ×ÊÀĞÅÂ ÔÈËÜÌ");
    ...
    while (x <= 250)
        ...
        txSetColor (TX_BLACK, 10);
        txSelectFont ("Tahoma", 40);
        txTextOut  (300, 100, "Èñòîğèÿ Êîëîíèçàöèè");
...
void EndTitles ()
    ...
    while (t < 265)
        ...
        txSelectFont ("Tahoma", 40);
        txTextOut  (1200 - t*3, 100, "ÏĞÎÄÎËÆÅÍÈÅ ÑËÅÄÓÅÒ");
...
void PlantingGarden ()
    ...
    while (t < 500)
        ...
        BoyDraw  (750 + 0.01*t, 700 - 0.61*t, 2, 2, 1,
                 ((t + 2) / 20) % 2 * 2,        ((t + 2) / 20) % 2 * 7,
                 ((t + 2) / 20) % 2,            ((t + 2) / 20) % 2 * 7,
                 ((t / 20) % 2 * (-1) + 1) * 2, ((t / 20) % 2 * (-1) + 1) * 7,
                 ((t / 20) % 2 * (-1) + 1),     ((t / 20) % 2 * (-1) + 1) * 7);
...
>>>>>>> 94c6da0591e2459aa6bd86f6a1d7d420049d593d
