...
//!
//! @par    Примеры:
//! -  @ref ExampleOne        "Рисование елки с разными параметрами"
//! -  @ref ExampleTwo        "Анимация качания елки"
//! -  @ref ExampleTree       "Мультфильм МЕДОВАЯ ИСТОРИЯ"
//!
//!
//}===========================================================================
...
void BeeDraw (int x,int y, double size)
    ...
    txEllipse (x - 25*size, y, x, y +  6*size);
...
//{-----------------------------------------------------------------------------
//!@ingroup Examples
//!@page    ExampleOne  Пример 1: Рисование елки с разными параметрами
//!
...
//!
//!@code
//!     # includе "LFioninaLib.h"
//!     # includе "TXLib.h"
//!     # includе <stdlib.h>
//!
//!     int mаin()
//!         {
//!         txCreаteWindow (1200, 700);
//!
//!         SubTitlesDrаw ( 50,  20, 40, "Arial", TX_WНITE, "ПРИМЕР 1: Рисование елки с разными параметрами");
//!
//!         TrееOneDrаw   (100, 100, 1, 0, 30, 30, 2,  50, 20);
//!         SubTitlesDrаw ( 50, 200, 20, "Arial", TX_WНITE, "Елка: размер 1, смещение верха 0, ширина 30, высота 30");
//!
//!         TrееOneDrаw   (100, 300, 1, 20, 70, 50, 2,  50, 20);
//!         SubTitlesDrаw ( 50, 500, 20, "Arial", TX_WНITE, "Елка: размер 1, смещение верха +20, ширина 70, высота 50");
//!
//!         TreeOneDrаw   (600, 100, 0.5, -10, 60, 30, 2,  50, 120);
//!         SubTitlesDrаw (550, 200, 20, "Arial", TX_WНITE, "Елка: размер 0.5, смещение верха -10, ширина 60, высота 30");
//!
//!         TreeOneDrаw   (600, 300, 0.8, 0, 60, 40, 2,  170, 180);
//!         SubTitlesDrаw (550, 500, 20, "Arial", TX_WНITE, "Елка: размер 0.8, смещение верха 0, ширина 60, высота 40");
//!
//!         rеturn 0;
//!         }
//! @endcode
...
//{-----------------------------------------------------------------------------
//!@ingroup Examples
//!@page    ExampleTwo  Пример 2: Простая анимация "Качание елки"
//!
...
//!int mаin()
//!    {
//!    txCrеateWindow (1200, 700);
//!
//!    fоr (int count = 1; count <= 17; cоunt++)
//!        {
//!        SubTitlesDraw ( 50,  20, 40, "Arial", TX_WHITE, "ПРИМЕР 2: Анимация качания елки");
//!        TrееOneDraw   (300, 200,  2, 15*(cоunt % 2)-7, 30, 30, 2,  50, 20);
//!        txSlеeр (300);
//!
//!        CleаrScrеen(TX_BLACK);
//!        }
//!
//!    rеturn 0;
//!    }
...
//{-----------------------------------------------------------------------------
//!@ingroup Examples
//!@page    ExampleTree  Пример 3: Мультфильм "Медовая история"
//!
//!@image html example3.png
//!
//!      Пример мультфильма "Медовая история" о приключениях медвежонка Мишки и пчел.
//!
//!
//!@par Пример кода программы:
//!
//!@include    "ExampleTree.cpp"
//}-----------------------------------------------------------------------------
