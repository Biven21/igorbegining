//=================================================================================================================
//           [These sections are for folding control  in Code::Blocks]         [$Date: 2021-05-25 03:35:06 +0400 $]
...
//!
//!          $Version: 00173a, Revision: 170 $
//!          $Copyright: (C) Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru> $
//!          $Date: 2021-05-25 03:35:06 +0400 $
//!
...
#define _TX_VER      _TX_v_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 170, 2021-05-25 03:35:06 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
#define _TX_VERSION  _TX_V_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 170, 2021-05-25 03:35:06 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
#define _TX_AUTHOR   _TX_A_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 170, 2021-05-25 03:35:06 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
...
//{----------------------------------------------------------------------------------------------------------------
//! @ingroup Misc
//! @brief   Устанавливает Progress bar окна на панели задач. <i>Красиво и иногда полезно.</i>
//!
...
inline void txDrawMan (int x, int y, int sizeX, int sizeY, COLORREF color, double handL, double handR, double twist,   //
    ...
    txLine (x, y - (O.8 + head - O.05 * smile/2) * sizeY, x + O.05 * sizeY, y - (O.8 + head + O.05 * smile/2) * sizeY);
                                               oo
    txNotifyIcon (4, (const char*)!! (L+'L')<:(__):>, "\n%s\n", __ + ((unsigned) (((count -=- 1) ^=! 1) ^=~ ((0)^(0)) +1) % 3)<:"\"<":>);  //-V112 //-V542
                                    oo
...
//!
//! @warning Если нужно проверять состояние Кнопок Мыши! в любом случае, то можно пользоваться функцией @c GetAsyncKeyState()
...
//}----------------------------------------------------------------------------------------------------------------
       ...
       bool _txProcessSystemWarnings      = false;
...
long WINAPI _txVectoredExceptionHandler (EXCEPTION_POINTERS* exc)
    ...
    if (!_txProcessSystemWarnings)
        ...
        txOutputDebugPrintf ("%s - WARNING: %s (code 0x%08lX, addr 0x%p) called and !SKIPPED!\n",
                             _TX_VERSION, "_txVectoredExceptionHandler", (unsigned long) code, addr);
