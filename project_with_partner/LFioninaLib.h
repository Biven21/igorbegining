...
void BeeDraw (int x,int y, double size, int Wave)
    {
    ...
    txEllipse (x - 15*size, y + Wave, x, y +  6*size);
    txEllipse (x + 15*size, y + Wave, x, y +  6*size);
    }

void BeeDrawHorizon (int x,int y, double size, int Wave)
    {
    txSetFillColor (RGB (30, 30, 0));
    txSetColor     (RGB (255, 255, 0),3);
    txCircle  (x - 5*size, y, 5*size);

    txEllipse (x, y - 5*size, x + 15*size, y + 5*size);

    txSetColor (RGB (255, 255, 0),2*size);
    txLine (x + 5*size, y - 4*size, x +  5*size, y +  4*size);
    txLine (x - 4*size, y - 4*size, x + 10*size, y +  4*size);

    txSetFillColor (RGB (185, 235, 225));
    txSetColor     (RGB (50, 50, 0),2);
    txEllipse (x + Wave, y - 15*size, x +  6*size, y);
    txEllipse (x + Wave, y + 15*size, x +  6*size, y);
    }
