    ...
    while (t <= 1500)
        {
         ...
         Village   ();
         GardenEnd ();
         HomeDraw (1000, 650, 150, 160, 90, 0.5);
         BearDraw (665, 495, 1.0, TX_YELLOW, 0, 1, 0, 30, 5, 25, 0, 25, 0, 21, 47, 19, 47);

         if (t < 700)
            {
             BeeDraw (750 + (t + 10) / 2, 500,                         1.5, 3 * (t%3));
             BeeDraw (750 + (t - 10) / 2, 450 + 50 / (1 + (t/4) %12),  1.5, 4);
             BeeDraw (750 + t / 2,        470 - 50 / (0.1 + (t/4) %6), 1.5, 5);
             BeeDraw (750 + (t - 30) / 2, 550 + 40 / (1 + (t/4) %20),  1.5, 6);
            }
         else
            {
             BeeDraw (1105 - (t - 700 + 10) / 2, 500,                         1.5, 1);
             BeeDraw (1095 - (t - 700 - 10) / 2, 450 + 50 / (1 + (t/4) %12),  1.5, 1);
             BeeDraw (1000 - (t - 700) / 2,      470 - 50 / (0.1 + (t/4) %6), 1.5, 4);
             BeeDraw (1085 - (t - 300) / 4,      550 + 40 / (1 + (t/4) %20),  1.5, 4 * (t%4));

             BeeDrawHorizon (1185 - (t - 300) / 4, 600 + 40 / (1 + (t/4) %20), 1.5, 4 * (t%4));
            }
